...
Text_Comp::Text_Comp(const std::string& text, const std::string& font, const int fontSize, const glm::vec4& color)
...
void Text_Comp::Start()
{
	m_pRenderComponent = m_pGameObject->GetComponent<Render_Comp>();
	InitializeText();
}

void Text_Comp::UpdateText(const std::string& newText)
{
	m_Text = newText;
