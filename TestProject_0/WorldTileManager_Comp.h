...
{
public:
	WorldTileManager_Comp(std::shared_ptr<Texture2D> pNormalTexture, std::shared_ptr<Texture2D> pHighlightTexture, float spaceBetweenTiles, int bottomRowAmount = 5);
...
private:
	...
	const float m_SpaceBetweenTiles;
